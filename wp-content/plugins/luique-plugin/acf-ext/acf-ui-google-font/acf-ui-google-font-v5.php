...
if( ! class_exists( 'acf_field_luique_ui_google_font' ) ) :

class acf_field_luique_ui_google_font extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*/
		...
		$this->label = __( 'Google Font', 'luique-plugin' );
		...
		<select name="<?php echo esc_attr( $field['name'] ); ?>" class="acf-select-google-fonts">
			...
			<option <?php if ( $field['value'] == $key ) : ?>selected="selected"<?php endif; ?> value="<?php echo esc_attr( $key ); ?>">
				...
				if ( $font["family"] ) :
					...
					echo esc_html__( '- Default -', 'luique-plugin' );
				endif;
				?>
			</option>
			<?php endforeach; ?>
...
// initialize
new acf_field_luique_ui_google_font();
